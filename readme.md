...
- Endpoint: `/api/v1/users/company/signup`
- Method: `POST`
...
- Endpoint: `/api/v1/users/company/login`
- Method: `POST`
...
- Endpoint: `/api/v1/users/company/forgotPassword`
- Method: `POST`
...
- Endpoint: `/api/v1/users/company/resetPassword/:token`
- Method: `PATCH`
...
- Endpoint: `/api/v1/users/companyverifyOTP`
- Method: `POST`
...
- Endpoint: `/api/v1/users/company/verify`
- Method: `POST`
...
- Endpoint: `/api/v1/users/company/verify-cac/:id`
- Method: `PATCH`
...
- Endpoint: `/api/v1/admin/users/company`
- Method: `GET`
...
- Endpoint: `/api/v1/admin/users/company/:id`
- Method: `GET`
